...
const LoginPage = () => {
  ...
  return (
    <div className="w-screen h-screen bg-blue-50 flex justify-center items-center">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg flex flex-col gap-6 w-96 border border-gray-200">
        <h2 className="text-gray-900 text-3xl font-semibold text-center">Welcome Back</h2>
          ...
          >
            {showPassword ? (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2 12s3-6 10-6 10 6 10 6-3 6-10 6-10-6-10-6z" />
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
